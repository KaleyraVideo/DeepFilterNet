...
#[no_mangle]
pub extern "C" fn Java_com_kaleyra_video_1extension_1noise_1filter_core_NativeDeepFilterNet_newNative(
    env: JNIEnv,
    _: JClass,
...
#[no_mangle]
pub extern "C" fn Java_com_kaleyra_video_1extension_1noise_1filter_core_NativeDeepFilterNet_freeNative(
    _env: JNIEnv,
    _: jclass,
    ptr: jlong,
) {
...
#[no_mangle]
pub extern "C" fn Java_com_kaleyra_video_1extension_1noise_1filter_core_NativeDeepFilterNet_getFrameLengthNative(
    _env: JNIEnv,
    _: jclass,
    ptr: jlong,
) -> jlong {
...
#[no_mangle]
pub extern "C" fn Java_com_kaleyra_video_1extension_1noise_1filter_core_NativeDeepFilterNet_setAttenLimNative(
    _env: JNIEnv,
    _: jclass,
    ptr: jlong,
    lim_db: jfloat,
...
#[no_mangle]
pub extern "C" fn Java_com_kaleyra_video_1extension_1noise_1filter_core_NativeDeepFilterNet_setPostFilterBetaNative(
    _env: JNIEnv,
    _: jclass,
    ptr: jlong,
    beta: jfloat,
...
#[no_mangle]
pub extern "C" fn Java_com_kaleyra_video_1extension_1noise_1filter_core_NativeDeepFilterNet_processFrameNative<'a>(
    mut env: JNIEnv<'a>,
    _: jclass,
    ptr: jlong,
